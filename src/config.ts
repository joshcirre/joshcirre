...
export const SITE: Site = {
    siteUrl: "https://joshcirre.com/", // Always put "/" at the end of the URL
    author: "Josh Cirre",
    desc: "Helping people help people.",
    title: "Josh Cirre",
    ogImage: "images/josh-cirre.png",
    keywords: "Founder, developer, learner, tinkerer, father, and husband.",
    postPerPage: 5
};
